...
if strcmp(action,'initialize'),
   ...
   figNumber=figure( ...
      'Name',getString(message('MATLAB:demos:truss:TitleBendingTruss')), ...
      'NumberTitle','off', ...
      'Visible','off', ...
      'Colormap',[]);
   axes( ...
   ...
   text(0,0,getString(message('MATLAB:demos:truss:LabelPressStartButtonToSeeDemo')), ...
   ...
   btnNumber=2;
   yPos=0.90-(btnNumber-1)*(btnHt+spacing);
   textStr=getString(message('MATLAB:demos:truss:LabelMode'));
...
elseif strcmp(action,'start'),
   ...
   text(2.5,1.7,getString(message('MATLAB:demos:truss:LabelBendingModesOfATruss')), ...
      'HorizontalAlignment','center');
   axis off;
